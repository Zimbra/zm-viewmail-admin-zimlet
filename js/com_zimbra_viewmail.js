...
if (ZaController.initToolbarMethods["ZaAccountViewController"]) {
    ZaController.initToolbarMethods["ZaAccountViewController"].push(ZaAccountViewMail.initExtraToolbarButton);
}

if (ZaController.initToolbarMethods["ZaDLController"]) {
    ZaController.initToolbarMethods["ZaDLController"].push(ZaAccountViewMail.initExtraToolbarButton);
}

if (ZaController.initToolbarMethods["ZaResourceController"]) {
    ZaController.initToolbarMethods["ZaResourceController"].push(ZaAccountViewMail.initExtraToolbarButton);
}
        ...
        if (item) {
            ...
            if ((item.type == ZaItem.ALIAS) && (item.attrs[ZaAlias.A_targetType] == ZaItem.DL)) {
                ...
                if(this._toolbarOperations[ZaOperation.VIEW_MAIL])
                    this._toolbarOperations[ZaOperation.VIEW_MAIL].enabled = enable;
            }
